...
if($endpage == ""){
	...
	$endpage = $endpage * $page_rows;
	if ($sca || $stx)
	{
		$sql = " select distinct wr_parent from $write_table where $sql_search $sql_order limit 0,  $endpage";
	}
	else
	{
		$sql = " select * from $write_table where wr_is_comment = 0 $sql_order limit 0, $endpage ";
	}
...
include_once("$board_skin_path/list.skin.ajax.php");
?>
