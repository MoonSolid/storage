...
public class Exam0110 {
  ...
  public static void main(String[] args) throws Exception {
    ...
    final HttpServer server = ServerBootstrap.bootstrap().setListenerPort(8888)        .setServerInfo("Bitcamp/1.1").setSocketConfig(socketConfig).setSslContext(null)
        .setExceptionLogger(new StdErrorExceptionLogger())
        .registerHandler("*", new HttpFileHandler("./webroot")).create();
                                                   //webroot디렉토리의 파일을 다룬다
...
//현재 디렉토리에 있는 index.html파일을 불러온다
